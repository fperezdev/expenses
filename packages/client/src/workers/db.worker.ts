...
function runMigrations(database: Database): void {
  ...
  const migrations: [string, string][] = [
    ...
    [
      ...
      ALTER TABLE payment_methods ADD COLUMN updated_at TEXT NOT NULL DEFAULT (datetime('now'));
      ALTER TABLE payment_methods ADD COLUMN deleted_at TEXT DEFAULT NULL;
      ALTER TABLE budgets ADD COLUMN updated_at TEXT NOT NULL DEFAULT (datetime('now'));
      ALTER TABLE budgets ADD COLUMN deleted_at TEXT DEFAULT NULL;
