...
// ─── Data management section (backup + export/import) ───
function DataManagementSection() {
  ...
  const handleFileSelect = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = async () => {
      ...
      const { parseCSVPreview } = await import("@/lib/import");
  ...
  const handleConfirmImport = async (mode: "replace" | "merge") => {
    ...
    setImporting(true);
    try {
      const { importFromCSV } = await import("@/lib/import");
